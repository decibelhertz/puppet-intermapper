...
describe 'intermapper::tool', type: :define do
  ...
  shared_context 'Supported Platform' do
    ...
    it do
      is_expected.to contain_file('/var/local/InterMapper_Settings/Tools/edu.ucsd.testtool').with(
        ensure: 'file',
        backup: nil,
        checksum: nil,
        checksum_value: nil,
        ...
        mode: '0644',
        owner: 'intermapper',
        path: '/var/local/InterMapper_Settings/Tools/edu.ucsd.testtool',
        provider: nil,
        purge: nil,
        recurse: nil,
        recurselimit: nil,
    ...
    describe 'ensure is set to directory' do
      ...
      it do
        is_expected.to contain_file('/var/local/InterMapper_Settings/Tools/edu.ucsd.testtool').with_ensure('directory')
      end
    end
    ...
    describe 'content is set' do
      ...
      it do
        is_expected.to contain_file('/var/local/InterMapper_Settings/Tools/edu.ucsd.testtool').with_content(c)
      end
    end
    ...
    describe 'source is set' do
      ...
      it do
        is_expected.to contain_file('/var/local/InterMapper_Settings/Tools/edu.ucsd.testtool').with_source(s)
      end
    end
    ...
    describe 'mode is set' do
      ...
      it do
        is_expected.to contain_file('/var/local/InterMapper_Settings/Tools/edu.ucsd.testtool').with_mode(m)
      end
    end
